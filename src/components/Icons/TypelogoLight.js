// TODO add DOTSafari typelogo here
...
export default function (){
    return (
        <>
            <defs>
                <style>
                    {`.cls-1{fill:#fcfafa;}.cls-2{fill:#e6007a;}`}
                </style>
            </defs>
            <g id="Layer_2" data-name="Layer 2">
                <g id="Layer_2-2" data-name="Layer 2">
                    ...
                    <path className="cls-1" d="M108.24,3.78h8.92v51h-8.92Z"/>
                    <path className="cls-1"
                    ...
                    <path className="cls-1" d="M331.64,18.38H359.9V25H331.64Zm9.63-9.78h9V54.74h-9Z"/>
                    <path className="cls-1"
                    ...
                    <path className="cls-1" d="M606.42,18.38h9V54.74h-9Z"/>
                    <ellipse className="cls-2" cx="83.69" cy="35.25" rx="2.19" ry="1.17"
                             transform="translate(-5.61 18.75) rotate(-12.37)"/>
                    <ellipse className="cls-2" cx="69.58" cy="35.25" rx="1.17" ry="2.19"
                             transform="translate(20.24 95.66) rotate(-77.63)"/>
                    <ellipse className="cls-2" cx="64.31" cy="43.11" rx="0.84" ry="1.42"
                             transform="translate(-12.8 36.16) rotate(-28.69)"/>
                    <ellipse className="cls-2" cx="66.06" cy="46.19" rx="0.6" ry="1.02"
                             transform="matrix(0.77, -0.64, 0.64, 0.77, -14.23, 53.35)"/>
                    <ellipse className="cls-2" cx="63.83" cy="34.81" rx="1.42" ry="0.84"
                             transform="translate(3.24 75) rotate(-62.17)"/>
                    <ellipse className="cls-2" cx="65.62" cy="31.11" rx="1.02" ry="0.6"
                             transform="translate(-0.42 61.32) rotate(-49.95)"/>
                    <ellipse className="cls-2" cx="67.54" cy="28.64" rx="0.72" ry="0.42"
                             transform="translate(2.16 61.91) rotate(-49.95)"/>
                    <ellipse className="cls-2" cx="69.32" cy="26.99" rx="0.6" ry="0.35"
                             transform="translate(4.06 62.68) rotate(-49.95)"/>
                    <ellipse className="cls-2" cx="72.63" cy="27.24" rx="1.02" ry="0.6"
                             transform="translate(5.04 65.31) rotate(-49.95)"/>
                    <ellipse className="cls-2" cx="63.48" cy="39.07" rx="1.89" ry="1.14"
                             transform="translate(19.8 99.47) rotate(-85.74)"/>
                    <ellipse className="cls-2" cx="80.7" cy="27.24" rx="0.59" ry="1.01"
                             transform="translate(0.78 56.69) rotate(-38.88)"/>
                    <ellipse className="cls-2" cx="89.64" cy="43.11" rx="1.41" ry="0.83"
                             transform="translate(9.83 102.48) rotate(-62.33)"/>
                    <ellipse className="cls-2" cx="87.93" cy="46.19" rx="1.01" ry="0.59"
                             transform="translate(-3.22 85.65) rotate(-51.12)"/>
                    <ellipse className="cls-2" cx="90.11" cy="34.81" rx="0.83" ry="1.41"
                             transform="translate(-6.01 44.44) rotate(-26.84)"/>
                    <ellipse className="cls-2" cx="88.36" cy="31.11" rx="0.59" ry="1.01"
                             transform="translate(0.05 62.35) rotate(-38.88)"/>
                    <ellipse className="cls-2" cx="86.48" cy="28.64" rx="0.41" ry="0.71"
                             transform="translate(1.18 60.62) rotate(-38.88)"/>
                    <ellipse className="cls-2" cx="84.73" cy="26.99" rx="0.35" ry="0.6"
                             transform="translate(1.83 59.16) rotate(-38.88)"/>
                    <ellipse className="cls-2" cx="90.45" cy="39.07" rx="1.12" ry="1.89"
                    ...
                    <ellipse className="cls-2" cx="310.65" cy="35.25" rx="2.19" ry="1.17"
                             transform="translate(-0.34 67.38) rotate(-12.37)"/>
                    <ellipse className="cls-2" cx="296.55" cy="35.25" rx="1.17" ry="2.19"
                             transform="translate(198.57 317.36) rotate(-77.63)"/>
                    <ellipse className="cls-2" cx="291.28" cy="43.11" rx="0.84" ry="1.42"
                             transform="translate(15.05 145.1) rotate(-28.69)"/>
                    <ellipse className="cls-2" cx="293.03" cy="46.19" rx="0.6" ry="1.02"
                             transform="matrix(0.77, -0.64, 0.64, 0.77, 39.01, 199.4)"/>
                    <ellipse className="cls-2" cx="290.79" cy="34.81" rx="1.42" ry="0.84"
                             transform="translate(124.24 275.71) rotate(-62.17)"/>
                    <ellipse className="cls-2" cx="292.59" cy="31.11" rx="1.02" ry="0.6"
                             transform="translate(80.49 235.05) rotate(-49.95)"/>
                    <ellipse className="cls-2" cx="294.5" cy="28.64" rx="0.72" ry="0.42"
                             transform="translate(83.07 235.64) rotate(-49.95)"/>
                    <ellipse className="cls-2" cx="296.29" cy="26.99" rx="0.6" ry="0.35"
                             transform="translate(84.97 236.41) rotate(-49.95)"/>
                    <ellipse className="cls-2" cx="299.6" cy="27.24" rx="1.02" ry="0.6"
                             transform="translate(85.95 239.04) rotate(-49.95)"/>
                    <ellipse className="cls-2" cx="290.45" cy="39.07" rx="1.89" ry="1.14"
                             transform="translate(229.89 325.81) rotate(-85.74)"/>
                    <ellipse className="cls-2" cx="307.66" cy="27.24" rx="0.59" ry="1.01"
                             transform="translate(51.05 199.14) rotate(-38.88)"/>
                    <ellipse className="cls-2" cx="316.6" cy="43.11" rx="1.41" ry="0.83"
                             transform="translate(131.38 303.48) rotate(-62.33)"/>
                    <ellipse className="cls-2" cx="314.89" cy="46.19" rx="1.01" ry="0.59"
                             transform="translate(81.29 262.33) rotate(-51.12)"/>
                    <ellipse className="cls-2" cx="317.08" cy="34.81" rx="0.83" ry="1.41"
                             transform="translate(18.44 146.91) rotate(-26.84)"/>
                    <ellipse className="cls-2" cx="315.32" cy="31.11" rx="0.59" ry="1.01"
                             transform="translate(50.32 204.81) rotate(-38.88)"/>
                    <ellipse className="cls-2" cx="313.44" cy="28.64" rx="0.41" ry="0.71"
                             transform="translate(51.46 203.08) rotate(-38.88)"/>
                    <ellipse className="cls-2" cx="311.69" cy="26.99" rx="0.35" ry="0.6"
                             transform="translate(52.11 201.62) rotate(-38.88)"/>
                    <ellipse className="cls-2" cx="317.42" cy="39.07" rx="1.12" ry="1.89"
                    ...
                    <ellipse className="cls-2" cx="610.92" cy="6.89" rx="7.63" ry="4.44"
